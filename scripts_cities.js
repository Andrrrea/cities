...
//Area Chart
    ...
    series: [{
        ...
        data: [
            ...
            cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],cities[0].Einwohnerzahl[4],
        ]
    }, {
        name: cities[1].name,
        ...
        data: [cities[2].Einwohnerzahl[0], cities[2].Einwohnerzahl[1], cities[2].Einwohnerzahl[2],
            cities[2].Einwohnerzahl[3], cities[2].Einwohnerzahl[4]
        ]
    }]
});
